...
DEPRECATED. Please use [`webpack-dev-server`](https://github.com/webpack/webpack-dev-server) (it is in support and update mode again). Feel free to create a issue if some features are not implemented in [`webpack-dev-server`](https://github.com/webpack/webpack-dev-server).
